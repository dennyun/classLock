    ...
    create TABLE tb_conquest (
       conquest_id bigint generated by default as identity,
        article_read integer,
        chapter_completed integer,
        quizz_completed integer,
        total_badges integer,
        total_xp integer,
        user_id bigint,
        primary key (conquest_id)
    )
...
COMMENT ON TABLE tb_badge is 'Inserção de badges';
insert into tb_badge ( badge_id, badge_name, badge_description, badge_image, badge_xp)
values ( 1,
'Comum Quizzer',
'Concluiu 3 Quizzes',
'https://cdn2.iconfinder.com/data/icons/quiz-filloutline/64/TARGET-question_mark-shoot-shooting-question-512.png',
20);
...
'Rare Quizzer',
'Concluiu 5 Quizzes',
'https://cdn2.iconfinder.com/data/icons/law-enforcement-soft-fill/60/Police_Badge-shield-police-policing-law-enforcement-512.png',
50);

INSERT INTO tb_badge ( badge_id, badge_name, badge_description, badge_image, badge_xp)
VALUES ( 3,
'The Explorer 1',
'Concluiu o Capítulo 1',
'https://cdn2.iconfinder.com/data/icons/law-enforcement-soft-fill/60/Police_Badge-shield-police-policing-law-enforcement-512.png',
200);
...
VALUES ( 4,
'The Explorer 2',
'Concluiu o Capítulo 2',
'https://cdn1.iconfinder.com/data/icons/law-28/512/Badge-law-police-security-symbolic-512.png',
200);
...
'Comum Reader',
'Leu 3 Artigos',
'https://cdn1.iconfinder.com/data/icons/detective-2/64/police_badge-badge-police-shield-256.png',
20);
...
'Rare Reader',
'Leu 5 Artigos',
'https://cdn4.iconfinder.com/data/icons/artificial-intelligence-47/64/Book-education-knowledge-learning-ai-512.png',
50);
...
'Epic Reader',
'Leu 10 Artigos',
'https://cdn1.iconfinder.com/data/icons/education-309/64/book-education-knowledge-learning-512.png',
100);

INSERT INTO tb_badge ( badge_id, badge_name, badge_description, badge_image, badge_xp)
VALUES ( 8,
'Winged Quizzer',
'Concluiu 1 Quizz em menos de 10 segundos',
'https://cdn3.iconfinder.com/data/icons/rock-and-roll-2/64/celebration-star-wing-events-party-512.png',
70);

COMMENT ON TABLE tb_chapter IS 'Inserção dos capítulos';
INSERT INTO tb_chapter (chapter_id, chapter_title, chapter_description, chapter_image) 
VALUES (
   1,
   '"Princípios Básicos da Segurança da Informação"', 
   'Neste capítulo você será apresentado a missões que irão testar os seus conhecimentos em torno dos princípios básicos da segurança da informação, para executar este capítulo com um melhor desempenho é nescessário compreender as características de cada um dos princípios.', 
   'https://makewebbetter.com/wp-content/uploads/2017/12/mainbanner1-1-1.jpg'
);

INSERT INTO tb_chapter (chapter_id , chapter_title, chapter_description, chapter_image) VALUES ( 
   2,
   '"Os Tipos de Hackers"', 
   '<p>Este capítulo será dedicado aos indivíduos que possuem uma facilidade e um conhecimento elevado em torno da manipulação código que permite o acesso a informações consideradas sigilosas, apesar que serem nomeados generalizadamente como Hackers há diferenças entre cada um deles que se dá por questões de índole ou nível de conhecimento e neste capítulos você deverá conhecer cada um deles.</p>', 
   'https://avante.biz/wp-content/uploads/Cool-Hacker-Wallpapers/Cool-Hacker-Wallpapers-014.jpg'
);


COMMENT ON TABLE tb_question IS 'Inserção dos Comentários dos Artigos';

INSERT INTO tb_comment( body, created_date, last_modified_date, post_id, user_id ) 
VALUES ( 'Concordo, todavia discordo.', now (), now (), 1, 2 );

INSERT INTO tb_comment( body, created_date, last_modified_date, post_id, user_id )
 VALUES ( 'Como eu faço pra acessar a câmera frontal do dispositivo de outra pessoa ?', now (), now (), 2, 1 );

INSERT INTO tb_comment( body, created_date, last_modified_date, post_id, user_id ) 
VALUES ( 'Eu investiguei e esta informação está errada!', now (), now (), 2, 3 );

INSERT INTO tb_comment( body, created_date, last_modified_date, post_id, user_id ) 
VALUES ( 'Como eu imprimo um vídeo ?', now (), now (), 3, 4 );


COMMENT ON TABLE tb_post IS 'Inserção dos Artigos Publicados';

insert into tb_post ( title, summary, views, body, user_id, post_image, created_by, created_date )
values(
   'Princípios básicos da Segurança da Informação',
   '"Porque é importante criar um esforço para seguir e manter os quatro princípios da Segurança da Informação e como eles influenciam na segurança e privacidade nos meios digitais e na vida real ?"',
   0,
...
COMMENT ON TABLE tb_question IS 'Inserção das Questões para os Quizzes';
INSERT INTO tb_question ( quest_id, quest_title, option_a, option_b, option_c, option_d, option_e, ans, chose )
VALUES ( 
   1,
   'Quais os princípios básicos da Segurança da Informação ?',
   'Confidencialidade, integridade, disponibilidade, autencidade',
   'Confidencialidade, não repúdio, disponibliidade, concistência',
   'Escalabilidade, integridade, autenticiadade, criptografia',
   'Durabilidade, integridade, tolerância, encapsulamento',
   'Confidencialidade, disponibilidade, autencidade',
   1,
   -1
);
...
VALUES ( 
   2,
   'Qual atributo corresponde ao nível de sigilo de uma informação ?',
   'Criptografia',
   'Confidencialidade',
   'Privacidade',
   'Isolamento',
...
VALUES ( 
   3,
   'Dados importantes em que a condição de inalterável deve durar o máximo possível, este princípio trata-se de:',
   'Autenticidade',
   'Durabilidade',
   'Disponibilidade',
   'Particionamento',
...
VALUES ( 
   4,
   'Qual indivíduo é responsável por um ataque autorizado com intenções justas ?',
   'Cracker',
   'Hackvista',
   'Grey Hat',
   'Hacker ético',
...
VALUES ( 
   5,
   'Invadir sistemas sem autorização, manipular códigos e coletar dados sigilosos em prol de causas sociais e éticas. Essas características referem-se ao: ',
   'Hackvista',
   'Newbie',
   'Hacker ético',
   'Grey Hat',
...
VALUES (    
   6,
   'Quem tem acesso a informações privilegiadas de uma determinada empresa é chamado de: ',
   'Cracker',
   'Hackvista',
   'Grey Hat',
   'Hacker ético',
...
COMMENT ON TABLE tb_user IS 'Tabela de Usuários';
INSERT INTO tb_user ( user_id, email, user_name, password, user_image )
VALUES (
   1,
   'jack@gmail.com',
   'Jack',
...
COMMENT ON TABLE tb_result IS 'Tabela com os Resultados para os Quizzes';

INSERT INTO tb_result (result_id, total_correct, user) 
VALUES(1,  3,'Jack' );
...
COMMENT ON TABLE tb_conquest IS 'Tabela de Conquistas do usuário';

INSERT INTO tb_conquest ( article_read, chapter_completed, quizz_completed, total_badges, total_xp, user_id )
VALUES(5, 2, 6, 4, 540, 1);

INSERT INTO tb_conquest ( article_read, chapter_completed, quizz_completed, total_badges, total_xp, user_id )
VALUES(3, 1, 4, 2, 220, 2);
